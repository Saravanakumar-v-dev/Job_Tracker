...
import { Sparkles, Mail, Lock, ArrowRight, User, Rocket } from 'lucide-react';
...
export const Register = () => {
    ...
    const handleGithubAuth = async (code) => {
        ...
        try {
            ...
            toast.success('Account accessed via GitHub!');
            navigate('/');
        } catch (error) {
    ...
    return (
        <div className="min-h-screen flex relative overflow-hidden page-bg">
            ...
            <div className="absolute top-[20%] right-[-10%] w-[40%] h-[40%] rounded-full bg-primary-600/20 blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-accent-600/20 blur-[120px] pointer-events-none" />
            ...
            <div className="hidden lg:flex flex-col justify-between w-1/2 p-16 relative z-10 border-r border-white/5">
                ...
                <div className="max-w-xl">
                    <h1 className="text-6xl font-display font-black text-theme-heading leading-[1.1] mb-6">
                        Join the elite <br/>
                        <span className="text-gradient">applicant club.</span>
                    </h1>
                    <p className="text-xl text-theme-secondary font-light mb-12 max-w-lg">
                        Accelerate your job search with powerful tracking, analytics, and organization tools designed for professionals.
                    </p>

                    <div className="space-y-6">
                        <div className="flex items-center gap-4 bg-slate-800/30 p-4 rounded-2xl border border-white/5">
                            <div className="w-10 h-10 rounded-xl bg-primary-500/20 flex items-center justify-center text-primary-400 font-bold">1</div>
                            <p className="text-slate-300 font-medium">Add applications in seconds</p>
                        </div>
                        <div className="flex items-center gap-4 bg-slate-800/30 p-4 rounded-2xl border border-white/5">
                            <div className="w-10 h-10 rounded-xl bg-accent-500/20 flex items-center justify-center text-accent-400 font-bold">2</div>
                            <p className="text-slate-300 font-medium">Visualize your interview pipeline</p>
                        </div>
                        <div className="flex items-center gap-4 bg-slate-800/30 p-4 rounded-2xl border border-white/5">
                            <div className="w-10 h-10 rounded-xl bg-emerald-500/20 flex items-center justify-center text-emerald-400 font-bold">3</div>
                            <p className="text-slate-300 font-medium">Land multiple job offers</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="glass-card p-10 rounded-[2rem] w-full">
                        ...
                        <p className="text-theme-secondary mb-8 font-medium">
                            Start tracking your job search today for free.
                        </p>

                        <form className="space-y-5" onSubmit={handleSubmit}>
                            <div>
                                <label className="block text-[11px] font-bold text-theme-secondary mb-2 uppercase tracking-wider">Full Name</label>
                            ...
                            <div>
                                <label className="block text-[11px] font-bold text-theme-secondary mb-2 uppercase tracking-wider">Email address</label>
                                <div className="relative group">
                            ...
                            <div>
                                <label className="block text-[11px] font-bold text-theme-secondary mb-2 uppercase tracking-wider">Password</label>
                                <div className="relative group">
                            ...
                            <button type="submit" disabled={loading} className="btn-primary w-full mt-4">
                                {loading ? (
                                    ...
                                    <span className="flex items-center gap-2">
                                        Start Hunting <ArrowRight className="w-5 h-5" />
                                    </span>
                                )}
                            </button>
                        ...
                        <p className="mt-8 text-center text-theme-secondary font-medium">
                            ...
                            <Link to="/login" className="text-primary-400 hover:text-primary-300 font-bold hover:underline transition-all">
                                Sign in
                            </Link>
                        </p>
                    </div>
